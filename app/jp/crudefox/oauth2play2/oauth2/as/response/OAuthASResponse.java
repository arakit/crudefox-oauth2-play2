...
import jp.crudefox.oauth2play2.oauth2.common.message.OAuthResponse;
...
public class OAuthASResponse extends OAuthResponse {
    ...
    private OAuthASResponse(String uri, int responseStatus) {
        super(uri, responseStatus);
    }

    public static OAuthAuthorizationResponseBuilder authorizationResponse(BridgeRequest request,int code) {
